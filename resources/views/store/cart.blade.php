                    ...
                    <div class="row align-items-center py-3 border-bottom"
                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-center gap-2">
                                <button type="button"
                                        class="btn btn-outline-secondary btn-sm minusBtn">
                                    −
                                </button>
                                ...
                                <button type="button"
                                        class="btn btn-outline-secondary btn-sm plusBtn">
                                    +
                                </button>
                            </div>
                        </div>
    ...
    cartRows.forEach(row => {
        ...
        function updateItemTotal() {
            ...
            .then(data => {
                ...
                if(cartSubtotalEl) cartSubtotalEl.innerText = formatMoney(data.cartTotal);
                if(cartTotalEl) cartTotalEl.innerText = formatMoney(data.cartTotal);
